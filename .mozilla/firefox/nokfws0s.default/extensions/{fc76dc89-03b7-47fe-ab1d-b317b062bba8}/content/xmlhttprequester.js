function xoopitforgmail_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
xoopitforgmail_xmlhttpRequester.prototype.contentStartRequest = function(details) {
    ...
    switch (scheme) {
        ...
        case "ftp":
            this.chromeWindow.setTimeout(
                xoopitforgmail_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
            break;
        default:
...
xoopitforgmail_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
xoopitforgmail_xmlhttpRequester.prototype.setupRequestEvent =
